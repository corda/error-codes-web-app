...
interface ValidationResult<TARGET : Any> {
    ...
    fun validValue(exceptionOnErrors: (Set<String>) -> Exception = { errors -> IllegalArgumentException(errors.joinToString(System.lineSeparator())) }): TARGET = value
            ?: throw exceptionOnErrors.invoke(errors)
