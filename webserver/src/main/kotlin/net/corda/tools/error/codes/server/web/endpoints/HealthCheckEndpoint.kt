...
internal class HealthCheckEndpoint @Inject constructor(configuration: HealthCheckEndpoint.Configuration) : ConfigurableEndpoint(configuration, setOf(HttpMethod.GET)) {
    ...
    private val answer = JsonObject().put("message", "Healthy as a horse!").put("revision_id", configuration.revisionId.value).put("source_url", "https://github.com/corda/error-codes-web-app/tree/${configuration.revisionId.value}")
